...
public class Field {
     ...
     * be lost.
     *
     * @param drawableActor The animal to be placed.
     * @param row    Row coordinate of the location.
     * @param col    Column coordinate of the location.
     */
    public void place(Actor drawableActor, int row, int col) {
        place(drawableActor, new Location(row, col));
    }
     ...
     */
    public void place(Actor drawableActor, Location location) {
        field[location.getRow()][location.getCol()] = drawableActor;
    }
